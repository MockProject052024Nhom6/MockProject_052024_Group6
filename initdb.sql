...
VALUES
    ...
    ('CUSTOMER_SUPPORT', 'Handles customer issues and inquiries.'),
    ('FINANCIAL_OFFICER', 'Manages financial transactions and payments.'),
    ('MARKETING_SPECIALIST', 'Responsible for marketing campaigns and advertising on the website.'),
    ('WAREHOUSE_MANAGER', 'Oversees and manages warehouse operations.'),
    ('USER', 'System users.'),
    ('CONTENT_MANAGER', 'Responsible for creating and managing content on the website.');
...
VALUES
    ('John', 'Doe', 'johndoe', '1985-04-23', '555-1234', '555-5678', 'johndoe@example.com', 'ACTIVE', 'Male', '$2a$10$6xGOkeozY2KP6xXRLSGb2.Ro1D9tORcjL/7CGsWmka6uhwDVdYcPi', 'USA', 'New York', 'NY', 50, '123456789', 1),
    ('Jane', 'Smith', 'janesmith', '1990-06-15', '555-2345', '555-6789', 'janesmith@example.com', 'ACTIVE', 'Female', '$2a$10$6xGOkeozY2KP6xXRLSGb2.Ro1D9tORcjL/7CGsWmka6uhwDVdYcPi', 'USA', 'Los Angeles', 'CA', 40, '987654321', 1),
    ('Michael', 'Johnson', 'michaelj', '1988-09-12', '555-3456', '555-7890', 'michaelj@example.com', 'ACTIVE', 'Male', '$2a$10$6xGOkeozY2KP6xXRLSGb2.Ro1D9tORcjL/7CGsWmka6uhwDVdYcPi', 'USA', 'Chicago', 'IL', 30, '112233445', 1),
    ('Emily', 'Davis', 'emilyd', '1995-03-10', '555-4567', '555-8901', 'emilyd@example.com', 'ACTIVE', 'Female', '$2a$10$6xGOkeozY2KP6xXRLSGb2.Ro1D9tORcjL/7CGsWmka6uhwDVdYcPi', 'USA', 'Houston', 'TX', 40, '998877665', 1),
    ('David', 'Miller', 'davidm', '1982-01-18', '555-5678', '555-9012', 'davidm@example.com', 'ACTIVE', 'Male', '$2a$10$6xGOkeozY2KP6xXRLSGb2.Ro1D9tORcjL/7CGsWmka6uhwDVdYcPi', 'USA', 'Phoenix', 'AZ', 50, '776655443', 1),
    ('Sophia', 'Wilson', 'sophiaw', '1993-07-21', '555-6789', '555-0123', 'sophiaw@example.com', 'ACTIVE', 'Female', '$2a$10$6xGOkeozY2KP6xXRLSGb2.Ro1D9tORcjL/7CGsWmka6uhwDVdYcPi', 'USA', 'Philadelphia', 'PA', 30, '334455667', 1),
    ('James', 'Brown', 'jamesb', '1987-11-30', '555-7890', '555-1254', 'jamesb@example.com', 'ACTIVE', 'Male', '$2a$10$6xGOkeozY2KP6xXRLSGb2.Ro1D9tORcjL/7CGsWmka6uhwDVdYcPi', 'USA', 'San Antonio', 'TX', 40, '223344556', 1),
    ('Olivia', 'Jones', 'oliviaj', '1992-02-27', '555-8901', '555-2345', 'oliviaj@example.com', 'ACTIVE', 'Female', '$2a$10$6xGOkeozY2KP6xXRLSGb2.Ro1D9tORcjL/7CGsWmka6uhwDVdYcPi', 'USA', 'San Diego', 'CA', 50, '778899001', 1),
    ('Benjamin', 'Garcia', 'benjaming', '1984-05-16', '555-9012', '555-3456', 'benjaming@example.com', 'ACTIVE', 'Male', '$2a$10$6xGOkeozY2KP6xXRLSGb2.Ro1D9tORcjL/7CGsWmka6uhwDVdYcPi', 'USA', 'Dallas', 'TX', 30, '990011223', 1),
    ('Isabella', 'Martinez', 'isabellam', '1991-12-25', '555-0123', '555-4567', 'isabellam@example.com', 'ACTIVE', 'Female', '$2a$10$6xGOkeozY2KP6xXRLSGb2.Ro1D9tORcjL/7CGsWmka6uhwDVdYcPi', 'USA', 'San Jose', 'CA', 40, '223344667', 1),
    ('Alexander', 'Rodriguez', 'alexanderr', '1989-08-14', '555-1254', '555-5678', 'alexanderr@example.com', 'ACTIVE', 'Male', '$2a$10$6xGOkeozY2KP6xXRLSGb2.Ro1D9tORcjL/7CGsWmka6uhwDVdYcPi', 'USA', 'Austin', 'TX', 50, '334455778', 1),
    ('Mia', 'Hernandez', 'miah', '1994-11-03', '555-2346', '555-6780', 'miah@example.com', 'ACTIVE', 'Female', '$2a$10$6xGOkeozY2KP6xXRLSGb2.Ro1D9tORcjL/7CGsWmka6uhwDVdYcPi', 'USA', 'Jacksonville', 'FL', 30, '445566889', 1),
    ('Ethan', 'Martinez', 'ethanm', '1986-03-22', '555-3457', '555-7891', 'ethanm@example.com', 'ACTIVE', 'Male', '$2a$10$6xGOkeozY2KP6xXRLSGb2.Ro1D9tORcjL/7CGsWmka6uhwDVdYcPi', 'USA', 'Fort Worth', 'TX', 40, '556677990', 1),
    ('Ava', 'Lopez', 'aval', '1995-09-01', '555-4568', '555-8902', 'aval@example.com', 'ACTIVE', 'Female', '$2a$10$6xGOkeozY2KP6xXRLSGb2.Ro1D9tORcjL/7CGsWmka6uhwDVdYcPi', 'USA', 'Columbus', 'OH', 50, '667788001', 1),
    ('William', 'Gonzalez', 'williamg', '1983-07-19', '555-5679', '555-9013', 'williamg@example.com', 'ACTIVE', 'Male', '$2a$10$6xGOkeozY2KP6xXRLSGb2.Ro1D9tORcjL/7CGsWmka6uhwDVdYcPi', 'USA', 'Charlotte', 'NC', 30, '778899112', 1),
    ('Harper', 'Perez', 'harperp', '1990-04-08', '555-6790', '555-0124', 'harperp@example.com', 'ACTIVE', 'Female', '$2a$10$6xGOkeozY2KP6xXRLSGb2.Ro1D9tORcjL/7CGsWmka6uhwDVdYcPi', 'USA', 'Indianapolis', 'IN', 40, '889900223', 1),
    ('Daniel', 'Thompson', 'danielt', '1987-06-26', '555-7901', '555-1235', 'danielt@example.com', 'ACTIVE', 'Male', '$2a$10$6xGOkeozY2KP6xXRLSGb2.Ro1D9tORcjL/7CGsWmka6uhwDVdYcPi', 'USA', 'San Francisco', 'CA', 50, '990011334', 1),
    ('Chloe', 'Anderson', 'chloea', '1992-11-15', '555-8012', '555-2346', 'chloea@example.com', 'ACTIVE', 'Female', '$2a$10$6xGOkeozY2KP6xXRLSGb2.Ro1D9tORcjL/7CGsWmka6uhwDVdYcPi', 'USA', 'Seattle', 'WA', 30, '001122445', 1),
    ('Matthew', 'Taylor', 'matthewt', '1984-10-04', '555-9123', '555-3457', 'matthewt@example.com', 'ACTIVE', 'Male', '$2a$10$6xGOkeozY2KP6xXRLSGb2.Ro1D9tORcjL/7CGsWmka6uhwDVdYcPi', 'USA', 'Denver', 'CO', 40, '112233556', 1),
    ('Ella', 'Thomas', 'ellat', '1991-05-23', '555-0124', '555-4568', 'ellat@example.com', 'ACTIVE', 'Female', '$2a$10$6xGOkeozY2KP6xXRLSGb2.Ro1D9tORcjL/7CGsWmka6uhwDVdYcPi', 'USA', 'Washington', 'DC', 50, '223344667', 1);
...
VALUES
    ('Antique Vase', 'An ancient Chinese porcelain vase', '19*30*100 cm', 'China', 'Like New', 1, 'PENDING_REVIEW', 3, 2, 1, 4, 1, 1),
    ('Painting', 'A famous oil painting from the 19th century', '120*90 cm', 'France', 'Like New', 1, 'REVIEW_FAILED', 5, 4, 2, 5, 2, 1),
    ('Vintage Car', 'Classic car from the 1960s in mint condition', '4000*1600*1200 mm', 'USA', 'Like New', 1, 'UNDER_EVALUATION', 14, 7, 3, 3, 1, 1),
    ('Diamond Necklace', 'High-quality diamond necklace', '45*20*5 mm', 'India', 'Like New', 1, 'EVALUATION_FAILED', 20, 10, 4, 6, 2, 1),
    ('Rare Coin Collection', 'A collection of ancient coins', '5*5*0.3 cm', 'Italy', 'Like New', 1, 'EVALUATED', 3, 13, 5, 7, 1, 1),
    ('Vintage Furniture Set', 'Victorian-era furniture set', '200*150*80 cm (table), 100*50*120 cm (chair)', 'UK', 'Like New', 1, 'PENDING_WAREHOUSE', 5, 18, 6, 8, 2, 1),
    ('Signed Sports Memorabilia', 'Autographed baseball memorabilia', '30*40 cm (poster)', 'USA', 'Like New', 1, 'WAREHOUSED', 14, 2, 7, 9, 1, 1),
    ('Rare Book Collection', 'First-edition books from various authors', '25*18*5 cm', 'France', 'Like New', 1, 'SOLD', 20, 4, 8, 10, 2, 1),
    ('Vintage Wine Collection', 'Rare wine bottles from around the world', '30*10*10 cm (bottle)', 'Italy', 'Like New', 1, 'SOLD', 3, 7, 9, 1, 1, 1),
    ('Antique Clock', 'A beautiful antique grandfather clock', '180*50*30 cm', 'Germany', 'Like New', 1, 'PENDING_REVIEW', 5, 10, 10, 2, 2, 1),
    ('Art Deco Jewelry', 'Exquisite art deco jewelry pieces', '15*10*5 cm (box)', 'USA', 'Like New', 1, 'PENDING_REVIEW', 14, 13, 1, 3, 1, 1),
    ('Rare Stamp Collection', 'Rare stamps from different countries', '10*8*0.1 cm', 'UK', 'Like New', 1, 'REVIEW_FAILED', 20, 18, 2, 4, 2, 1),
    ('Vintage Camera Set', 'Collection of vintage cameras', '20*15*10 cm (camera)', 'Japan', 'Like New', 1, 'SOLD', 3, 2, 3, 5, 1, 1),
    ('Fine Art Sculpture', 'Sculpture by a renowned artist', '100*50*50 cm', 'France', 'Like New', 1, 'REVIEW_FAILED', 5, 4, 4, 6, 2, 1),
    ('Rare Manuscript', 'Ancient manuscript with historical significance', '30*20*5 cm', 'Italy', 'Like New', 1, 'UNDER_EVALUATION', 14, 7, 5, 7, 1, 1),
    ('Collectible Toy Set', 'Rare collectible toys from the 1980s', '10*10*5 cm (each toy)', 'USA', 'Like New', 1, 'EVALUATION_FAILED', 20, 10, 6, 8, 2, 1),
    ('Vintage Poster Collection', 'Original vintage posters', '70*50 cm (each poster)', 'France', 'Like New', 1, 'SOLD', 3, 13, 7, 9, 1, 1),
    ('Rare Music Instruments', 'Rare musical instruments from various eras', '120*40*20 cm (violin)', 'UK', 'Like New', 1, 'EVALUATED', 5, 8, 8, 10, 2, 1),
    ('Fine Jewelry Collection', 'High-end jewelry collection', '10*10*5 cm (each piece)', 'Italy', 'Like New', 1, 'PENDING_WAREHOUSE', 14, 2, 9, 1, 1, 1),
    ('Antique Furniture', 'Antique furniture pieces', '200*150*80 cm (table), 100*50*120 cm (chair)', 'Germany', 'Like New', 1, 'WAREHOUSED', 20, 4, 10, 2, 2, 1),
    ('Classic Car', 'Classic car restoration project', '4000*1600*1200 mm', 'USA', 'Like New', 1, 'SOLD', 3, 7, 1, 3, 1, 1),
    ('Rare Artwork', 'Rare artworks by famous artists', '120*90 cm', 'France', 'Like New', 1, 'PENDING_REVIEW', 5, 10, 2, 4, 2, 1),
    ('Vintage Wine', 'Vintage wine bottles', '30*10*10 cm (bottle)', 'Italy', 'Like New', 1, 'PENDING_REVIEW', 14, 13, 3, 5, 1, 1),
    ('Fine Art Painting', 'Fine art painting by a renowned artist', '180*120 cm', 'UK', 'Like New', 1, 'PENDING_REVIEW', 20, 18, 4, 6, 2, 1),
    ('Rare Coin', 'Rare coins from various historical periods', '5*5*0.3 cm', 'USA', 'Like New', 1, 'SOLD', 3, 2, 5, 7, 1, 1),
    ('Vintage Furniture', 'Vintage furniture set', '200*150*80 cm (table), 100*50*120 cm (chair)', 'France', 'Like New', 1, 'REVIEW_FAILED', 5, 4, 6, 8, 2, 1),
    ('Signed Sports Memorabilia', 'Autographed sports memorabilia', '30*40 cm (poster)', 'Italy', 'Like New', 1, 'REVIEW_FAILED', 14, 7, 7, 9, 1, 1),
    ('Rare Book', 'Rare first-edition books', '25*18*5 cm', 'Germany', 'Like New', 1, 'UNDER_EVALUATION', 20, 10, 8, 10, 2, 1),
    ('Vintage Wine Collection', 'Collection of vintage wines', '30*10*10 cm (bottle)', 'USA', 'Like New', 1, 'SOLD', 3, 13, 9, 1, 1, 1),
    ('Antique Clock', 'Antique clock from the 19th century', '180*50*30 cm', 'France', 'Like New', 1, 'UNDER_EVALUATION', 5, 18, 10, 2, 2, 1);
